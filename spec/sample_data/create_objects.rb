...
def create_objects
  ...
  let!(:invoice2c) { create(:invoice, :completed, customer: customer2) } # ii_status = shipped
  ...
  let!(:invoice6c) { create(:invoice, :completed, customer: customer6) } # ii_status = shipped
